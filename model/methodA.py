...
class CModel():
    ...
    def Setting(self, image, img_size = (1,480,640), video=False, checkpoint_path='./checkpoints/'):
        ...
        self.__strCkptPath = checkpoint_path + "dqn_" + self.__strKptDetection + "_checkpoint_A.pth"
        self.__bVideo = video

        if(video):
            fourcc = cv2.VideoWriter_fourcc(*'MPEG')
            self.__oVideo = cv2.VideoWriter("./Video_A_" + str(self.__strKptDetection) + ".mp4", fourcc, 25.0, (self.__uWidth * 2, self.__uHeight))
